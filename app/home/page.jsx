    ...
    <div>
      ...
      <div className="container mx-auto flex justify-between">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 mt-16 flex-1">
          ...
          <div>
            <article class="flex items-center gap-4 rounded-lg h-32 p-6 sm:justify-between">
          ...
          <div>
            <article class="flex items-center gap-4 h-32 rounded-lg p-6 sm:justify-between">
              <div></div>
      ...
      <footer class="bg-gray-100 rounded-lg shadow-md m-12 dark:bg-gray-800 max-w-screen-2xl mx-auto">
